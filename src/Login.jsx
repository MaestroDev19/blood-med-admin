            ...
            <div className="flex flex-col space-y-10">
               ...
               <div className="space-y-5 md:w-[380px] w-full">
                ...
                <label htmlFor="UserPassword" className="relative block overflow-hidden border border-rasin-black px-3 pt-3 focus-within:border-munshell focus-within:ring-1 focus-within:ring-munshell">
                  <input type="password" id="UserPassword"placeholder="pass" className="peer h-8 w-full  border-none bg-transparent p-0 placeholder-transparent   focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm"/>
               ...
               <Button className="p-3.5  bg-munshell text-seasalt text-center font-medium text-base" name="Login"/>
            </div>
          </form>
        </main>
        </>
